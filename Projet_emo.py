...
model.add(keras.layers.Conv1D(128, 5, padding='same', input_shape=(517,1), activation='relu'))
...
model.fit(train_data, train_labels, batch_size=500, epochs=150, validation_data=(val_data, val_labels))
