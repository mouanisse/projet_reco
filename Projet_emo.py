...
train_data = np.load('/content/drive/My Drive/Colab Notebooks/emotion_dataset/train_emotions3.npy')
test_val_data = np.load('/content/drive/My Drive/Colab Notebooks/emotion_dataset/test_emotions3.npy')
...
model.add(keras.layers.Conv1D(128, 5, padding='same', input_shape=(259,1), activation='relu'))
...
model.fit(train_data, train_labels, batch_size=500, epochs=50, validation_data=(val_data, val_labels))
