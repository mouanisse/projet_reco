...
train_data = np.load('/content/drive/My Drive/Colab Notebooks/emotion_dataset/train_emotions_3_RAVDESS.npy')
test_val_data = np.load('/content/drive/My Drive/Colab Notebooks/emotion_dataset/test_emotions_3_RAVDESS.npy')
train_labels = np.load('/content/drive/My Drive/Colab Notebooks/emotion_dataset/train_labels_3_RAVDESS.npy')
test_val_labels = np.load('/content/drive/My Drive/Colab Notebooks/emotion_dataset/test_labels_3_RAVDESS.npy')
